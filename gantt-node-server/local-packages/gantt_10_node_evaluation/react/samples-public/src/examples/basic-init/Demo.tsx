...
import ReactGantt, {Task, Link, GanttConfig, ReactGanttRef, GanttTemplates, useWorkTime, CalendarConfig, Marker} from "@dhx/trial-react-gantt";
  ...
  const calendars: CalendarConfig[] = [
    {
      ...
      worktime: {
        ...
        days: {
          weekdays: [0, 1, 1, 1, 1, 1, 0], // Sunday and Saturday are non-working days
          dates: {
