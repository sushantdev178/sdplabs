...
export const recalculateImpact = async ({ workspace_id, project_id, task_id, start_at, due_at, operation, link_id, link }) => { // <-- Add 'link'
...
export const calculateImpactPreview = async ({ workspace_id, project_id, task_id, start_at, due_at, operation, link_id, link }) => { // <-- Add 'link_id' and 'link'
    // Pass everything straight through to recalculateImpact
    const result = await recalculateImpact({ workspace_id, project_id, task_id, start_at, due_at, operation, link_id, link });
